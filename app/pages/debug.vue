  ...
  <div class="min-h-screen bg-gray-50 p-8">
    <div class="max-w-4xl mx-auto">
      ...
      <div class="card mb-8">
        ...
        <div class="space-y-3">
          <div v-for="(value, key) in envVars" :key="key" class="flex justify-between items-center p-3 bg-gray-50 rounded">
      ...
      <div class="card mb-8">
        ...
        <div class="space-y-4">
          <button @click="testLoginApi" class="btn btn-primary" :disabled="isTesting">
            {{ isTesting ? '测试中...' : '测试登录 API' }}
          </button>
          <button @click="testUserApi" class="btn btn-secondary" :disabled="isTesting">
      ...
      <div class="card">
        ...
        <div v-if="errors.length === 0" class="text-gray-500">
          暂无错误
        </div>
        <div v-else class="space-y-2">
          <div v-for="(error, index) in errors" :key="index" class="p-3 bg-red-50 border border-red-200 rounded">
